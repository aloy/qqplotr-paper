...
\textbackslash{}begin\{Schunk\} \textbackslash{}begin\{figure\}

\{\centering \includegraphics[width=0.4\linewidth]{loy-figures/qqline-1}
\includegraphics[width=0.4\linewidth]{loy-figures/qqline-2}
\includegraphics[width=0.4\linewidth]{loy-figures/qqline-3}
\includegraphics[width=0.4\linewidth]{loy-figures/qqline-4}

\}

\textbackslash{}caption{[}Q-Q plots of a sample of size \(n=50\) drawn
...
\hh{For both, distributional parameters are estimated separately for each group. This means that each group compares againsta different distribution when comparing  against the identity line as `the' theoretical distribution   XXX bit awkwardly phrased}
