...
\item
  ...
  parameter and produce the more powerful adjusted detrended Q-Q plots,
...
Figure \ref{fig:urine-qq-bands} \al{also} provides an overview of
...
\item
  ...
  \al{Kolmogorov-type simultaneous confidence bands.}
\item
  The right column displays Q-Q plots with 95\% tail-sensitive
  \al{simultaneous} confidence bands.
  \al{Notice that these are substantially narrower in the tails than the Kolmogorov-type bands.}
\item
