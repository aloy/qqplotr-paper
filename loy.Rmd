...
Confidence bands can be drawn around the reference line using one of four methods: simultaneous Kolmogorov-type bounds, a pointwise normal approximation \citep{Davison:1997}, the parametric bootstrap, or the tail-sensitive procedure \citep{Aldor-Noiman2013-xw}.
...
Figure \ref{fig:urine-qq-bands} provides an overview of \pkg{qqplotr}'s capabilities: 
...
* The right column displays Q-Q plots with 95% tail-sensitive confidence bands.
