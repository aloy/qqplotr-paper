...
\hh{This makes the de-trended version of a Q-Q plot  cognitively easier to process: cognitive research \citep{sineillussion, robbins, clevelands} suggestst that onlookers have a tendency to intuitively assess the distance between points and lines based on the shortest distance (i.e. the orthogonal distance) rather than the vertical distance appropriate for the situation. In the de-trended Q-Q plot the line to compare points to is rotated to be the $x$-axis, which makes orthogonal distance equal to the vertical distance. }
