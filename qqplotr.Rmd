...
```
```{r, echo=FALSE, fig.width = 4, fig.height = 3.5, fig.cap = "Sample (200 men and 200 women) of weights. Unlike people's height, weight seems to be heavily right skewed with some additional outliers on the extreme left.", out.width='\\textwidth', fig.align="center", message=FALSE, warning = FALSE}
