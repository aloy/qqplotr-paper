...
The top row of plots in Figure \ref{fig:urine-qq-bands} shows the three different band types, and the bottom row shows the adjusted detrended versions of these plots. Comparing the Q-Q plots across the different band types reveals that the choice of confidence band can have substantial impact on the interpretation of a Q-Q plot...
