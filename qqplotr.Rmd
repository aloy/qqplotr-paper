...
p9 <- urine %>% ggplot(aes(sample = ph)) + 
  stat_qq_band(alpha = 0.5, bandType = "normal", fill = "red") + 
  stat_qq_line(col = "darkred") + 
  stat_qq_point() +
  ggtitle("Normal") +
  xlab("Theoretical quantiles") +
  ylab("pH") +
...
p10 <- urine %>% ggplot(aes(sample = ph)) + 
  stat_qq_band(alpha = 0.5, bandType = "bs", fill = "green") + 
...
p11 <- urine %>% ggplot(aes(sample = ph)) + 
  stat_qq_band(alpha = 0.5, bandType = "ts", fill = "blue") + 
