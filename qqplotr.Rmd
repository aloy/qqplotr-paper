...
an option to detrend the plotted points (see \nameref{sec:introduction}). Moreover, all other
implemented stats from Q-Q and P-P plots also allow the detrend adjustment.
...
* `stat_qq_band`: draws confidence bands based on three methods: *Normal*, *Bootstrap*, and *Tail-sensitive*:
	...
	intervals;
	+ **Bootstrap**: creates pointwise confidence bands with parametric boostrap;
