...
Intercept and slope of these lines relate to mean and scale parameters
of the theoretical and the empirical distribution, respectively. By
comparing these two lines we learn about how well the parameters
...
on the Q-Q line and the Q-Q points, i.e., those get shifted and scaled
in the plot, but relative relationships do not change aside a change in
scales. For other distributions, such as a log normal, re-specifications
of the parameters result in non-linear transformations of the Q-Q line
and Q-Q points (see Figure \ref{fig:qqline} for an example).
