...
\item
  ...
  methods: \emph{Normal} theory, \emph{Bootstrap} resampling, and
  \emph{Tail-sensitive} simultaneous bands.
...
\subsubsection{Adding confidence bands}\label{adding-confidence-bands}

In this section we elaborate on the construction of each type of
confidence band allowed in \texttt{stat\_qq\_band}.

\textbf{Normal} Specifying \texttt{bandType\ =\ "norm"} constructs
pointwise confidence bands based on
