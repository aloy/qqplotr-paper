...
create detrended Q-Q plots, and how to create Q-Q plots when data are
...
\Aa{implements two types of reference lines: one that is the identity line, and another that passes through two quantiles of the distributions, such as the first and third quartiles}.
While those are the most traditional used reference lines, alternative
ones can be quickly implemented, for instance, using
