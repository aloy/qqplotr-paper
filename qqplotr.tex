...
\caption[Sample (200 men and 200 women) of weights (raw data, left]{Sample (200 men and 200 women) of weights (raw data, left; jittered data, right). Unlike people's height, weight seems to have heavier tails than a normal distribution. Jittereing (on the right) emphasizes that the distribution of weight is heavily right skewed.}\label{fig:unnamed-chunk-6}
\end{figure}
\end{Schunk}
